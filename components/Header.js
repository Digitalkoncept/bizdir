            ...
            <div className="hom-nav  db-open ">
              ...
              <div className="top-ser">
                <form name="filter_form" id="filter_form" className="filter_form">
                 ...
                 <div className={`al duration-500 ${authStatus? 'block':'hidden'}`} onMouseEnter={() => setDashboardVisiblity(true)} onMouseLeave={() => setDashboardVisiblity(false)} >
             ...
             <ul className={`bl ${authStatus ? 'hidden':'block'}`} >
              <li>
              ...
              <li>
                <Link href="/login?login=signup">Create an account</Link>
              </li>
            </ul>
